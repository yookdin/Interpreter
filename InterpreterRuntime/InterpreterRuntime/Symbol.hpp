...
enum Symbol {
	START = -1,
    BLOCK, COMMAND_CALL, EXP, FUNC_CALL, NAMED_PARAM, NAMED_PARAMS_LIST, PARAMS_LIST, SEND_COMMAND, STATEMENT, STATEMENTS, 
    ...
    BREAK, CONTINUE, ELSE, IF, NOT, OR, REPEAT, SEND, TIMES, WHILE, 
