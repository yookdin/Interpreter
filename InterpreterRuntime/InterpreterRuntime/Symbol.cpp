...
bimap<Symbol, string> symbol_str_map = {
    {START, "START"}, {BLOCK, "BLOCK"}, {COMMAND_CALL, "COMMAND_CALL"}, {EXP, "EXP"}, {FUNC_CALL, "FUNC_CALL"}, {NAMED_PARAM, "NAMED_PARAM"}, {NAMED_PARAMS_LIST, "NAMED_PARAMS_LIST"}, {PARAMS_LIST, "PARAMS_LIST"}, {STATEMENT, "STATEMENT"}, {STATEMENTS, "STATEMENTS"}, 
    ...
    {BREAK, "break"}, {CONTINUE, "continue"}, {ELSE, "else"}, {IF, "if"}, {NOT, "not"}, {OR, "or"}, {REPEAT, "repeat"}, {TIMES, "times"}, {WHILE, "while"}, 
};
